...
// Create the context
export const CardEffectDialogContext = createContext<CardEffectDialogContextType | undefined>(undefined);
...
// Reducer function
function cardEffectDialogReducer(state: CardEffectDialogState, action: CardEffectDialogAction): CardEffectDialogState {
  switch (action.type) {
    case 'SHOW_DIALOG':
      return {
        ...state,
