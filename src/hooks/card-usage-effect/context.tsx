...
// Create the context
export const CardUsageEffectContext = createContext<
  CardUsageEffectContextType | undefined
>(undefined);
...
// Provider component
export const CardUsageEffectProvider = ({
  children,
}: {
  children: ReactNode;
}) => {
  ...
  // Action creators
  const showCardUsageEffect = (
    params: CardUsageEffectParams,
  ): Promise<void> => {
