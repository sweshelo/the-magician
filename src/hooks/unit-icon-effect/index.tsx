...
export const useUnitIconEffect = () => {
  ...
  const triggerEffect = useCallback(() => {
    if (!isAnimating) {
      ...
      console.log(
        "UnitIconEffect: Animation already in progress, ignoring trigger",
      );
    }
  }, [isAnimating]);
  ...
  const handleAnimationComplete = useCallback(() => {
    ...
    console.log("Current animation states before reset:", {
      showEffect,
      isAnimating,
    });
    ...
    setTimeout(() => {
      ...
      console.log("Animation states after reset:", {
        showEffect: false,
        isAnimating: false,
      });
    }, 0);
