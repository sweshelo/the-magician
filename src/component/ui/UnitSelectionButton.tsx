...
export const UnitSelectionButton = ({ unitId }: UnitSelectionButtonProps) => {
  ...
  const buttonConfig = {
    select: { text: '選択', bgColor: 'bg-white', textColor: 'text-black', borderColor: 'border-gray-500' },
    target: { text: 'ターゲット', bgColor: 'bg-red-500', textColor: 'text-white', borderColor: 'border-red-700' },
    block: { text: 'ブロック', bgColor: 'bg-blue-500', textColor: 'text-white', borderColor: 'border-blue-700' },
  };
